...
FC_Rect FC_DrawButtonLeft(FC_Font* font, FC_Target* dest, FC_Rect box, const char* formatted_text)
{
    FC_Rect box2=box;
    box2.y=box.y+(box.h-FC_GetLineHeight(font))/2;
    FC_DrawBox(font,dest,box2,formatted_text);
    return box;
}

FC_Rect FC_DrawButtonCenter(FC_Font* font, FC_Target* dest, FC_Rect box, const char* formatted_text)
{
    FC_Rect box2=box;
    box2.y=box.y+(box.h-FC_GetLineHeight(font))/2;
    FC_DrawBoxAlign(font,dest,box2,FC_ALIGN_CENTER,formatted_text);
    return box;
}
